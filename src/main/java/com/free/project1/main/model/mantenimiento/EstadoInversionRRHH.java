...
@Entity(name = "ESTADO_INVERSION_RRHH")
public class EstadoInversionRRHH {
    ...
    public EstadoInversionRRHH() {
    }

    public EstadoInversionRRHH(int id, String descripcion, Date fechacreacion, Date fechamodificacion, String codmodusu,
            String chkactivo, String chkmarca) {
        this.id = id;
    ...
    public String toString() {
        return "{" + " 'id':'" + getId() + "'" + ", 'descripcion':'" + getDescripcion() + "'" + ", 'fechacreacion':'"
                + getFechacreacion() + "'" + ", 'fechamodificacion':'" + getFechamodificacion() + "'"
                + ", 'codmodusu':'" + getCodmodusu() + "'" + ", 'chkactivo':'" + getChkactivo() + "'" + ", 'chkmarca':'"
                + getChkmarca() + "'" + "}";
    }
}